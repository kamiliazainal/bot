...
console.log("sendJsonMessage " + keyword);
  if (_.has(scriptRules, keyword.toUpperCase())) {
    ...
    sendSingleJsonMessage(recipientId,"HELLO.json");
  }
}
...
"title": "Swipe left/right for more options.",
            "subtitle": "Choose any help",
            "buttons": [
            {
              "type": "postback",
              "title": "Package i bought",
              "payload": "help with package"
            },
            {
              "type": "postback",
              "title": "Accommodation I booked",
...
{
   sendTextMessage(recipientId,"Please enter your booking number");
...
function addKeywordText(recipientId)
{
   ...
   {
       sendTextMessage(recipientId,"Thank you. We will contact you as soon as possible. If you have other questions, please click on Repeat.");
